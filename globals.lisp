...
(defconstant +feature-type-small-warehouse+ 7)
(defconstant +feature-type-med-warehouse+ 8)
(defconstant +feature-type-large-warehouse+ 9)
...
(defconstant +event-type-fire+ 4)
(defconstant +event-type-build-warehouse-1+ 5)
(defconstant +event-type-build-warehouse-2+ 6)
(defconstant +event-type-build-warehouse-3+ 7)
(defconstant +event-type-rot+ 8)
