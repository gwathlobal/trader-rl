...
(set-item-type-by-id +item-type-food+ (make-instance 'item-type :name "Purple helmets" :descr "In the underground world of Arq, mushrooms are grown for food." :base-price 5))
...
(set-item-type-by-id +item-type-wood+ (make-instance 'item-type :name "Yellow fungalwood" :descr "The world of Arq sees no sun, but its mushrooms can grow as big as any tree." :base-price 8))
